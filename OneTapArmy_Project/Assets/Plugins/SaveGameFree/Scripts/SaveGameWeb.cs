...
using System.IO;
using System.Text;
using Plugins.SaveGameFree.Scripts.Encoders;
using Plugins.SaveGameFree.Scripts.Serializers;
using UnityEngine;
using UnityEngine.Networking;
namespace Plugins.SaveGameFree.Scripts
{
	...
	public class SaveGameWeb
	{
		...
		/// <summary>
		/// Gets or sets a value indicating whether this <see cref="SaveGameWeb"/> default encode.
		/// </summary>
		...
		/// <summary>
		/// Gets or sets a value indicating whether this <see cref="SaveGameWeb"/> is encode.
		/// </summary>
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="SaveGameWeb"/> class.
		/// </summary>
