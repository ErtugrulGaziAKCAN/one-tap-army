...
namespace Obvious.Soap.Editor
{
    ...
    public class BindComparisonToUnityEventDrawer : UnityEditor.Editor
    {
        ...
        SerializedProperty _checkAfterStart;
        ...
        void OnEnable()
        {
            ...
            _checkAfterStart = serializedObject.FindProperty("CheckAfterStart");
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.PropertyField(_checkAfterStart, new GUIContent("CheckAfterStart"));
