...
namespace Obvious.Soap.Editor
{
    ...
    public class BindTextMeshProDrawer : UnityEditor.Editor
    {
        ...
        SerializedProperty _subscribeOnEnable;
        void OnEnable()
        {
            ...
            _subscribeOnEnable=serializedObject.FindProperty("_subscribeOnAwake");
        }
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.PropertyField(_subscribeOnEnable, new GUIContent("SubscribeOnEnable"));
