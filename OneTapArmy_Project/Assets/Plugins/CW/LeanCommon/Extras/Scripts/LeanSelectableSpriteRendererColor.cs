...
namespace Plugins.CW.LeanCommon.Extras.Scripts
{
	...
	[CustomEditor(typeof(LeanSelectableSpriteRendererColor))]
	public class LeanSelectableSpriteRendererColor_Editor : CwEditor
	{
		protected override void OnInspector()
		{
			LeanSelectableSpriteRendererColor tgt; LeanSelectableSpriteRendererColor[] tgts; GetTargets(out tgt, out tgts);
