...
using UnityEditor;
using UnityEngine;
namespace Plugins.CW.LeanPool.Examples.Scripts
{
	...
	[HelpURL(Required.Scripts.LeanPool.HelpUrlPrefix + "LeanPoolDebugger")]
	[AddComponentMenu(Required.Scripts.LeanPool.ComponentPathPrefix + "Pool Debugger")]
	public class LeanPoolDebugger : MonoBehaviour
	{
		...
		private bool Exists()
		{
			if (Required.Scripts.LeanPool.Links.TryGetValue(gameObject, out cachedPool) == true)
			{
				return true;
			}
	...
	[CustomEditor(typeof(LeanPoolDebugger), true)]
	public class LeanPoolDebugger_Editor : CwEditor
	{
		protected override void OnInspector()
		{
			LeanPoolDebugger tgt; LeanPoolDebugger[] tgts; GetTargets(out tgt, out tgts);
