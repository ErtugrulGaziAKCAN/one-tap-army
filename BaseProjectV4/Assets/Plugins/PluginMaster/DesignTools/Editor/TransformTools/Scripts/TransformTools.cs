...
using System.Linq;
using Plugins.PluginMaster.DesignTools.Editor.Common.Scripts;
using UnityEngine;
namespace Plugins.PluginMaster.DesignTools.Editor.TransformTools.Scripts
{
    public static class TransformTools
    {
        ...
        private static GameObject GetAnchorObject(GameObject[] selection, RelativeTo relativeTo,
            AxesUtils.Axis axis, Space space, bool recursive = true)
        {
        ...
        public static void AlignGlobal(GameObject[] selection, RelativeTo relativeTo,
            AxesUtils.Axis axis, Bound bound,
        ...
        public static void AlignLocal(GameObject[] selection, RelativeTo relativeTo, AxesUtils.Axis axis,
        ...
        public static void Align(GameObject[] selection, RelativeTo relativeTo, AxesUtils.Axis axis,
        ...
        #endregion
        #region DISTRIBUTE
        public static void Distribute(GameObject[] selection, AxesUtils.Axis axis, Bound bound)
        {
        ...
        public static void DistributeGaps(GameObject[] selection, AxesUtils.Axis axis,
        ...
        public class ArrangeData
        {
            ...
            private System.Collections.Generic.List<AxesUtils.Axis> _priorityList
                = new System.Collections.Generic.List<AxesUtils.Axis>
                { AxesUtils.Axis.X, AxesUtils.Axis.Y, AxesUtils.Axis.Z };
            ...
            public ArrangeAxisData GetData(AxesUtils.Axis axis)
            {
                return axis == AxesUtils.Axis.X ? x : axis == AxesUtils.Axis.Y ? y : z;
            }
            public void UpdatePriorities(AxesUtils.Axis axis)
            {
            ...
            public AxesUtils.Axis GetAxisByPriority(int priority) => _priorityList[priority];
        ...
        public static bool Arrange(GameObject[] selection, ArrangeData data)
        {
            ...
            float[] GetCellSizes(AxesUtils.Axis mainAxis, out float totalSize)
            {
                totalSize = 0f;
                ...
                for (int a = 0; a < mainAxisData.cells; ++a)
                {
                    ...
                    AxesUtils.Axis secondaryAxis1 = AxesUtils.Axis.Y;
                    AxesUtils.Axis secondaryAxis2 = AxesUtils.Axis.Z;
                    if (mainAxis == AxesUtils.Axis.Y)
                    {
                        secondaryAxis1 = AxesUtils.Axis.X;
                        secondaryAxis2 = AxesUtils.Axis.Z;
                    }
                    else if (mainAxis == AxesUtils.Axis.Z)
                    {
                        secondaryAxis1 = AxesUtils.Axis.X;
                        secondaryAxis2 = AxesUtils.Axis.Y;
                    }
                    ...
                    for (int b = 0; b < seondaryAxisData1.cells; ++b)
                        ...
                        {
                            var i = mainAxis == AxesUtils.Axis.X
                                ? a : secondaryAxis1 == AxesUtils.Axis.X ? b : c;
                            var j = mainAxis == AxesUtils.Axis.Y
                                ? a : secondaryAxis1 == AxesUtils.Axis.Y ? b : c;
                            var k = mainAxis == AxesUtils.Axis.Z
                                ? a : secondaryAxis1 == AxesUtils.Axis.Z ? b : c;
                            if (objDictionary.ContainsKey((i, j, k))) objList.Add(objDictionary[(i, j, k)]);
                        }

                    var size = BoundsUtils.GetMaxSize(objList.ToArray());
                    cellSizes[a] = mainAxis == AxesUtils.Axis.X
                        ? size.x : mainAxis == AxesUtils.Axis.Y ? size.y : size.z;
                    totalSize += cellSizes[a];
                }
            ...
            var cellSizesX = GetCellSizes(AxesUtils.Axis.X, out ArrangementSize.x);
            var cellSizesY = GetCellSizes(AxesUtils.Axis.Y, out ArrangementSize.y);
            var cellSizesZ = GetCellSizes(AxesUtils.Axis.Z, out ArrangementSize.z);
            ...
            void ComputeAutoSpacing(AxesUtils.Axis axis, RectTransform rectTransform)
            {
                ...
                var axisSpan = AxesUtils.GetAxisValue(span, axis);
                AxesUtils.SetAxisValue(ref spacing, axis, axisSpan / axisData.cells);
                var axisCanvasSize = AxesUtils.GetAxisValue(rectTransform.rect.size, axis);
                var axisSpacing = AxesUtils.GetAxisValue(spacing, axis);
                var canvasCellSize = axisCanvasSize / axisData.cells - axisSpacing;
                var axisCanvasPosition = AxesUtils.GetAxisValue(rectTransform.rect.position, axis);
                AxesUtils.SetAxisValue(ref firstCellCenter, axis,
                    axisCanvasPosition + (axisCanvasSize + canvasCellSize + axisSpacing) / 2);
                if (axisData.aligment == Bound.MIN)
                    AxesUtils.AddValueToAxis(ref firstCellCenter, axis, -axisSpacing / 2);
                else if (axisData.aligment == Bound.MAX)
                    AxesUtils.AddValueToAxis(ref firstCellCenter, axis, axisSpacing / 2);
                var cellSizes = axis == AxesUtils.Axis.X ? cellSizesX : cellSizesY;
            ...
            if (data.x.autoSpacing || data.y.autoSpacing)
            {
                ...
                if (commonParent != null)
                {
                    ...
                    ComputeAutoSpacing(AxesUtils.Axis.X, rectTransform);
                    ComputeAutoSpacing(AxesUtils.Axis.Y, rectTransform);
                }
            }
        ...
        public class ProgressionData
        {
            ...
            public Rect GetRect(AxesUtils.Axis axis)
            {
                switch (axis)
                {
                    case AxesUtils.Axis.X:
        ...
        public static void HomogenizeSpacing(GameObject[] selection, HomogenizeData data)
        {
            ...
            if (data.x.homogenize) DistributeGaps(selection, AxesUtils.Axis.X, data.x.strength, false);
            if (data.y.homogenize) DistributeGaps(selection, AxesUtils.Axis.Y, data.y.strength, false);
            if (data.z.homogenize) DistributeGaps(selection, AxesUtils.Axis.Z, data.z.strength, false);
        }
        ...
        public class UnoverlapData
        {
            ...
            public UnoverlapAxisData GetData(AxesUtils.Axis axis)
            {
                return axis == AxesUtils.Axis.X ? _x : axis == AxesUtils.Axis.Y ? _y : _z;
            }
        }
        ...
        private class OverlapedObject
        {
            ...
            private void MoveTest(AxesUtils.Axis axis, bool unoverlap,
            ...
            public bool ExecuteBestSolution(UnoverlapData unoverlapData)
            {
                ...
                {
                    MoveTest(AxesUtils.Axis.X, unoverlapData.x.unoverlap, solution, ref minVol, ref bestMove);
                    MoveTest(AxesUtils.Axis.Y, unoverlapData.y.unoverlap, solution, ref minVol, ref bestMove);
                    MoveTest(AxesUtils.Axis.Z, unoverlapData.z.unoverlap, solution, ref minVol, ref bestMove);
                }
        ...
        private static float GetVectorComponent(Vector3 v, AxesUtils.Axis axis)
        {
            return axis == AxesUtils.Axis.X ? v.x : axis == AxesUtils.Axis.Y ? v.y : v.z;
        }

        private static Vector3 GetMoveVector(float move, AxesUtils.Axis axis)
        {
            return new Vector3(axis == AxesUtils.Axis.X
                ? move : 0f, axis == AxesUtils.Axis.Y
                ? move : 0f, axis == AxesUtils.Axis.Z ? move : 0f);
        }

        private static void GetOverlapedDataAxis(AxesUtils.Axis axis, UnoverlapData unoverlapData,
            ...
            UnoverlapData unoverlapData, bool getSolutionVolumen)
        {
            ...
            if (retVal.volume > 0)
            {
                ...
                GetOverlapedDataAxis(AxesUtils.Axis.X, unoverlapData,
                    selection, index, b1, b2, getSolutionVolumen,
                    ref retVal, ref minVol, ref bestMove);
                GetOverlapedDataAxis(AxesUtils.Axis.Y, unoverlapData,
                    selection, index, b1, b2, getSolutionVolumen,
                    ref retVal, ref minVol, ref bestMove);
                GetOverlapedDataAxis(AxesUtils.Axis.Z, unoverlapData,
                    selection, index, b1, b2, getSolutionVolumen,
                    ref retVal, ref minVol, ref bestMove);
            }
            return retVal;
            ...
            PlaceOnSurfaceUtils.PlaceOnSurfaceData data, GameObject[] filters)
        {
            ...
            bool Raycast(Vector3 rayOrigin, out RaycastHit hitInfo)
            {
                if (data.placeOnColliders)
                    return Physics.Raycast(rayOrigin, worldProjDir, out hitInfo, float.MaxValue, data.mask);
                hitInfo = new RaycastHit();
                RaycastHit meshHitInfo, colliderHitInfo;
                bool meshHit = MeshUtils.Raycast(rayOrigin, worldProjDir,
                    out meshHitInfo, out GameObject collider, filters, float.MaxValue);
                bool colliderHit = Physics.Raycast(rayOrigin, worldProjDir,
                    out colliderHitInfo, float.MaxValue, data.mask);
